...
//            'visibility_filter' => ['show_actual_columns'],
        ...
        $this->addExportType('*/salesByCoupon/exportSalesByCouponCsv', __('CSV'));
        $this->addExportType('*/salesByCoupon/exportSalesByCouponExcel', __('Excel XML'));
