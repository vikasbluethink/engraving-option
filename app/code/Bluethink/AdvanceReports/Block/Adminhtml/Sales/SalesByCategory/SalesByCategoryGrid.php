...
class SalesByCategoryGrid extends AbstractGrid
{
    ...
    protected function _construct()
    {
        ...
        $this->setId('SalesByCategoryGrid');
...
//            $this->_addCustomFilter($resourceCollection, $filterData);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('category_id', [
            ...
            'index' => 'category_id',
            'width' => 100,
            'renderer'        => 'Bluethink\AdvanceReports\Block\Adminhtml\Grid\Column\Renderer\Category',
