...
class Detailed extends ReportSales implements HttpGetActionInterface
{
    /**
     * report action
     *
...
//            __('Sales Overview')
//        );
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Sales Detailed'));

        $gridBlock = $this->_view->getLayout()->getBlock('sales.detailed');
