...
class SalesByCategory extends ReportSales implements HttpGetActionInterface
{
    /**
     * report action
     *
...
//            __('Sales Overview')
//        );
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Sales By Category'));

        $gridBlock = $this->_view->getLayout()->getBlock('sales.by.category');
